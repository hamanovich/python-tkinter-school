...
messages = {
    "play_button": "Сыграть все разделы сразу",
    "game_score_caveat": "Набирайте баллы и выигрывайте, за каждое правильное задание +1 балл",
    ...
    "msg_result_less_5": "К сожалению вы смогли справиться с недостаточным количеством заданий. Попробуйте заново, как будете готовы.",
    ...
    "game_over": "Игра окончена. Спасибо за участие!",
}
...
intro = {
    "rules": [
        "Добро пожаловать в увлекательный мир Биологии!",
        "Впереди вас ждёт множество увлекательных и интересных заданий.",
        ...
        "В конце игры мы поделимся результатом с вами."
    ],
...
content = {
    "botanika": {
        ...
        "tasks": [
            {
                "name": "Необходимо классифицировать вишню обыкновенную, расположив в порядке иерархичности 5 подходящих элементов из предложенных",
                "rule": "(В клеточки введите цифры от 1 до 8, начиная с наименьшего элемента)",
                "options": [
                    (1, "Род Вишня"),
                    (2, "Отряд Цветковые"),
                    (3, "Царство Растения"),
            ...
            },
            {
                ...
                "rule": "(Заполните клеточки, вставляя пропущенные буквы. 1 балл получите, если ключевое слово будет верным)",
                "options": [
                    {
            ...
            },
            {
                ...
                "rule": "(Перетащите картинки в нужные места на фоне)",
                "options": [
                    (1, {"x": 20, "y": 135,
        ...
        "tasks": [
            {
                ...
                "rule": "(Нажимайте на нужные элементы, чтобы выбрать их. Подсказка: элементы могут повторяться)",
                "options": [
                    (1, "Аорта"),
            ...
            },
            {
                ...
                "rule": "(Перетащите слова на нужные позиции. По ссылке ниже вы можете узнать больше о строении глаза)",
                "options": [
            ...
            },
            {
                ...
                "rule": "(Перетащите слова на нужные позиции. Подсказка: макроэлементов больше, чем микроэлементов)",
                "elements": [
        ...
        "tasks": [
            {
                ...
                "rule": "(Перетащите картинки на фон. Подсказка: не все органоиды нужны. Ненужные органоиды можно оставить внизу)",
                "options": [
                    ("аппарат гольджи", {
            ...
            },
            {
                ...
                "rule": "(Выберите один из трех вариантов ответа для каждого органоида)",
                "options": [
            ...
            },
            {
                ...
                "rule": "(Перетащите картинки в нужные места на фоне. Запутались? Нажмите на кнопку \"Подсказка\")",
                "options": [
                    ("дерма", {

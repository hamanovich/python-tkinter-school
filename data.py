...
messages = {
    ...
    "msg_result_0": "Вы не решили ни одного задания. Возможно вы были не готовы и вам необходимо повторить материал и повторить прохождение заново.",
    "msg_result_less_5": "К сожалению вы смогли справиться только с несколькими заданиями. Попробуйте заново, как будете готовы.",
    "msg_result_5_6": "В неплохо справились с большинством заданий, но допустили несколько ошибок. Попробуйте заново и у вас непременно получится еще лучше!",
    "msg_result_7_8": "Поздравляем, вы отлично справились с заданиями и прошли игру!",
    "msg_result_9": "Невероятно! Вы прошли всю игру без ошибок. Так держать!",
}
